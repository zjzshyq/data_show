...
# cover：Who’s Helping Ukraine? Nominal Donations from Countries
'''
Data source: ifw-kiel.de
BGM: Stamatis Spanoudakis - You Will Come Like Lightning
'''
canvas.add_title('Ukraine Aid: Nominal Contributions by Country (2022-2024)', color=(0,0,0))
canvas.add_sub_title('Unit: Million USD(M)', color=(111,111,111))
